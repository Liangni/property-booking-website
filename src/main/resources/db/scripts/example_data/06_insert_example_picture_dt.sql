...
INSERT INTO picture_dt (picture_id, picture_dt_size, picture_dt_storage_path, picture_dt_is_uploaded)
SELECT picture_id, -- 從 picture 表中選擇 picture_id 欄位
       size, -- 選擇由 VALUES 子句創建的 sizes 臨時表中的size列
       CONCAT('properties/1/size-', size, '/d7640f50-66d4-4c3a-bb4f-f34837248f1', size ,'.png'),
       true
FROM (VALUES (1), (2), (3)) AS sizes(size) -- 創建一個包含尺寸的臨時表sizes
CROSS JOIN picture -- 與 picture 表交叉組合以獲取圖片 picture_id
WHERE picture_storage_path = 'properties/1/size-original/7f3b28ab-a802-43cc-bca6-14b0c6653811.png';
...
CROSS JOIN picture
WHERE picture_storage_path = 'properties/1/size-original/7f3b28ab-a802-43cc-bca6-14b0c6653812.png';
...
FROM (VALUES (1), (2), (3)) AS sizes(size)
         CROSS JOIN picture
WHERE picture_storage_path = 'properties/1/size-original/7f3b28ab-a802-43cc-bca6-14b0c6653813.png';
...
FROM (VALUES (1), (2), (3)) AS sizes(size)
         CROSS JOIN picture
WHERE picture_storage_path = 'properties/2/size-original/7f3b28ab-a802-43cc-bca6-14b0c6653821.png';
...
FROM (VALUES (1), (2), (3)) AS sizes(size)
         CROSS JOIN picture
WHERE picture_storage_path = 'properties/2/size-original/7f3b28ab-a802-43cc-bca6-14b0c6653822.png';
...
FROM (VALUES (1), (2), (3)) AS sizes(size)
         CROSS JOIN picture
WHERE picture_storage_path = 'properties/2/size-original/7f3b28ab-a802-43cc-bca6-14b0c6653823.png';
...
FROM (VALUES (1), (2), (3)) AS sizes(size)
         CROSS JOIN picture
WHERE picture_storage_path = 'properties/3/size-original/7f3b28ab-a802-43cc-bca6-14b0c6653831.png';
...
FROM (VALUES (1), (2), (3)) AS sizes(size)
         CROSS JOIN picture
WHERE picture_storage_path = 'properties/3/size-original/7f3b28ab-a802-43cc-bca6-14b0c6653832.png';
...
FROM (VALUES (1), (2), (3)) AS sizes(size)
         CROSS JOIN picture
WHERE picture_storage_path = 'properties/3/size-original/7f3b28ab-a802-43cc-bca6-14b0c6653833.png';