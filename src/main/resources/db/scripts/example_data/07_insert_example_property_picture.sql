...
FROM (
         SELECT 'properties/1/size-original/7f3b28ab-a802-43cc-bca6-14b0c6653811.png' AS picture_storage_path, 1 AS order_num, 'test property 1' AS property_title
         UNION ALL
         ...
         JOIN picture pic ON pic.picture_storage_path = subquery.picture_storage_path;